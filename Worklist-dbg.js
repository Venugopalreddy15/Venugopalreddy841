sap.ui.define([
		...
		"ProjectTime/ZProjectTime/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("Gjahr"),
									name: oBindingContext.getProperty("Apr")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all Actuals_Line_Item to be able to check for the total amount
						this.waitFor(this.createAWaitForAnEntitySet({
							entitySet: "Actuals_Line_Item",
